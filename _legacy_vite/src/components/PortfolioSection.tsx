...
export const PortfolioSection: React.FC = () => {
    ...
    const handleScroll = () => {
        if (scrollRef.current) {
            ...
            // const itemWidth = container.offsetWidth; // Approximate, or generic width

            // Simple logic: card width is mostly screen or fixed. 
            // Better logic: finding which element is closest to center
                ...
                >
                    {projectsData.map((project, index) => (
                        <Link
                            ...
                            data-project-card
                            className="group relative flex-none w-[85vw] sm:w-[600px] snap-center"
                            draggable="false"
                        >
